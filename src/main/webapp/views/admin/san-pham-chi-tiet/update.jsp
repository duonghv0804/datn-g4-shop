            ...
            <form:form action="${action}"
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <form:select path="idSanPham" id="idSanPham" class="form-select" disabled="true">
                    ...
                    <div class="col-4">
                        ...
                        <form:select name="idMauSac" id="idMauSac" path="idMauSac" multiple="true" disabled="true">
                    ...
                    <div class="col-4">
                        ...
                        <form:select path="idKichCo" id="idKichCo" name="idMauSac" multiple="true" disabled="true">
                ...
                <div class="mt-3">
                    <a href="/admin/san-pham-chi-tiet/index" class="btn btn-secondary">Hủy</a>
...
<script>
    ...
    // Vô hiệu hóa MultiSelect
    document.querySelector('.multi-select-tag').classList.add('disabled');
</script>
