...
<div class="container mt-3">
    ...
    <div class="row mt-3">
        ...
        <div class="col-3 mt-4">
            <form:form id="edit-form" modelAttribute="th" method="post" action="/admin/thuong-hieu/store">
            ...
            <c:if test="${thuongHieuPage.totalPages > 1}">
                <ul class="pagination">
                    ...
                    <li class="page-item <c:if test="${thuongHieuPage.number == thuongHieuPage.totalPages - 1}">disabled</c:if>">
                        <a class="page-link" href="?page=${thuongHieuPage.totalPages}">Cuối</a>
                    </li>
                </ul>
            </c:if>
        </div>
...
<script>
    $(".update-button").click(function () {
        ...
        // Thực hiện yêu cầu AJAX để lấy dữ liệu thương hiệu dựa trên id
        $.ajax({
            url: "/admin/thuong-hieu/get/" + id,
            type: "GET",
            success: function (data) {
                $("#ten").val(data.ten);
                $("#trang_thai").val(data.trang_thai);

                $("#edit-form").attr("action", "/admin/thuong-hieu/update/" + id);
            },
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        clickClose.addEventListener("click", function () {
            ...
            $("#edit-form").attr("action", "/admin/thuong-hieu/store");
        });
    });
